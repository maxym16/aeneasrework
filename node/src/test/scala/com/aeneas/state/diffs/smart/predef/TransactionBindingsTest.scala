...
import com.aeneas.lang.Testing.evaluated
...
import com.aeneas.transaction.assets.exchange.{Order, OrderType}
import com.aeneas.transaction.smart.BlockchainContext.In
import com.aeneas.transaction.smart.{WavesEnvironment, buildThisValue}
import com.aeneas.transaction.{Proofs, ProvenTransaction, VersionedTransaction}
...
class TransactionBindingsTest
  ...
  def runForAsset(script: String): Either[String, EVALUATED] = {
    ...
    import com.aeneas.lang.v1.CTX._
